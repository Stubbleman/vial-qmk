...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASELAYER] = LAYOUT(
        ...
        KC_LSFT,              KC_Z,   KC_X,   KC_C,	  KC_V,   KC_B,      KC_N,   KC_M,   KC_COMM,	KC_DOT,	  KC_SLSH,	  KC_RSFT,
                                            ...
                                            KC_DEL, KC_SPC,KC_BSPC,       KC_ENT, MO(_ARROWLAYER), KC_MINS,
                                                   KC_LGUI,KC_LCTL,       KC_RALT, MO(_FUNCTIONLAYER)
    ...
    [_ARROWLAYER] = LAYOUT(
        ...
        MO(_FUNCTIONLAYER),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,  KC_TRNS,
        KC_TRNS,             KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
